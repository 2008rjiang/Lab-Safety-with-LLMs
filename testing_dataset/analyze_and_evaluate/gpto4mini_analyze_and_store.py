...
#   2) python gpto4mini_analyze_and_store.py --images-dir test_images --out test_outputs/gpto4mini
#
# FOLDER REQUIRED:
#   downloaded_images/
#     image0001.jpg
...
def main():
    ...
    # -------- write outputs --------
    jsonl_path = out_dir / "gpto4mini_model_responses.jsonl"
    with open(jsonl_path, "w", encoding="utf-8") as f:
        for r in rows:
            f.write(json.dumps(r, ensure_ascii=False) + "\n")

    csv_path = out_dir / "gpto4mini_model_responses.csv"
