...
#   - Calls GPT-5 mini on each image
...
#   2) python gpt5mini_analyze_and_store.py --images-dir test_images --out test_outputs/gpt5mini
#
# FOLDER REQUIRED:
#   downloaded_images/
#     image0001.jpg
...
def main():
    ...
    # -------- write outputs --------
    jsonl_path = out_dir / "gpt4o_model_responses.jsonl"
    with open(jsonl_path, "w", encoding="utf-8") as f:
        for r in rows:
            f.write(json.dumps(r, ensure_ascii=False) + "\n")

    csv_path = out_dir / "gpt4o_model_responses.csv"
